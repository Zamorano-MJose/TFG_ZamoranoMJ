...
asociada al marcador FIR059 en las fagáceas", en este trabajo se analizaron 19 especies pertenecientes a los géneros *Quercus*, *Castanea*, *Fagus* y *Castanopsis*, especificamente el gen que se transcribe al utilizar el marcador FIR059, el cual configura la proteína *DEAD-box ATP-dependent RNA helicase 7* (RH7). 
